...
// auto Rope::_shift_internal(const pRNode node) noexcept -> pRNode {
//   pRNode new_node{};
//   try {
...
// auto Rope::_insert(const pRNode node, const std::string &new_line) noexcept
//     -> void {
...
//       const pRNode new_node = _shift_internal(node->left);
